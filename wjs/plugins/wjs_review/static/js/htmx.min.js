(function (e, t) {
  ...
  return (function () {
    ...
    var C = {
      ...
      getAttributeValue: J,
      getClosestMatch: c,
      getExpressionVars: ur,
      getHeaders: Yt,
      getInputValues: Jt,
      getInternalData: Y,
      getSwapSpecification: tr,
      getTriggerSpecs: We,
      getTarget: he,
      makeFragment: l,
      mergeObjects: te,
    ...
    function U(e, t) {
      if (t.indexOf("closest ") === 0) {
        ...
        return [W(e, r(t.substr(9)))];
      } else if (t === "document") {
        return [document];
      } else if (t === "window") {
        return [window];
      } else {
        return Z().querySelectorAll(r(t));
      }
    }
    var _ = function (e, t) {
    ...
    function ve(t, r) {
      Q(t.attributes, function (e) {
        if (!r.hasAttribute(e.name) && de(e.name)) {
    ...
    function pe(e, i, a) {
      ...
      if (r) {
        ...
        i.parentNode.removeChild(i);
        ne(Z().body, "htmx:oobErrorNoTarget", { content: i });
      }
      return e;
    }
    function me(e, t, r) {
    ...
    function Ce(e) {
      ...
      if (t.onHandlers) {
        for (var r of t.onHandlers) {
          e.removeEventListener(r, t.onHandlers[r]);
        }
      }
    }
    function o(e) {
      ...
      switch (e) {
        ...
        default:
          ...
          if (e === "innerHTML") {
            ...
            Ie(z.config.defaultSwapStyle, t, r, n, i);
          }
      }
    }
    function ke(e) {
    ...
    function je(e) {
      ...
      var r = 0;
      while (r < e.length) {
        if (Xe.exec(e.charAt(r))) {
          var n = r;
          while (Fe.exec(e.charAt(r + 1))) {
            r++;
          }
          t.push(e.substr(n, r - n + 1));
        } else if (Be.indexOf(e.charAt(r)) !== -1) {
          var i = e.charAt(r);
          var n = r;
          r++;
    ...
    function Ve(e, t, r) {
      return Xe.exec(e.charAt(0)) && e !== "true" && e !== "false" && e !== "this" && e !== r && t !== ".";
    }
    function Ue(e, t, r) {
      if (t[0] === "[") {
        t.shift();
          ...
          if (o === "]") {
            ...
            if (n === 0) {
              ...
              try {
                ...
                ne(Z().body, "htmx:syntax:error", { error: e, source: i });
                return null;
              }
            }
          } else if (o === "[") {
    ...
    function Ge(e, t, r) {
      ...
      n.timeout = setTimeout(function () {
        if (ee(e) && n.cancelled !== true) {
          if (!Ye(r, Ht("hx:poll:trigger", { triggerSpec: r, target: e }))) {
            t(e);
          }
          Ge(e, t, r);
        }
    ...
    function Ye(e, t) {
      ...
      if (r) {
        try {
          ...
          ne(Z().body, "htmx:eventFilter:error", { error: e, source: r.source });
          return true;
        }
      }
      return false;
    }
    function Qe(i, a, e, o, s) {
      var l = Y(i);
      var t;
      if (o.from) {
        t = U(i, o.from);
    ...
    function rt() {
      if (!tt) {
        ...
        setInterval(function () {
          if (et) {
            et = false;
            Q(Z().querySelectorAll("[hx-trigger='revealed'],[data-hx-trigger='revealed']"), function (e) {
              nt(e);
            });
          }
        }, 200);
    ...
    function st(u) {
      ...
      if (f) {
        u.addEventListener(We(u)[0].trigger, function (e) {
          var t = Y(f).webSocket;
          var r = Yt(u, f);
          var n = Jt(u, "post");
          var i = n.errors;
    ...
    var At = location.pathname + location.search;
    function Nt() {
    ...
    function It(e, t, r, n) {
      ...
      ie(Z().body, "htmx:historyItemCreated", { item: o, cache: i });
      i.push(o);
      ...
      while (i.length > 0) {
        try {
          ...
          ne(Z().body, "htmx:historyCacheError", { cause: e, cache: i });
          i.shift();
        }
      }
    }
    ...
    function Mt() {
      ...
      var r = Z().querySelector('[hx-history="false" i],[data-hx-history="false" i]');
      if (!r) {
        ie(Z().body, "htmx:beforeHistorySave", { path: t, historyElt: e });
        It(t, Pt(e), Z().title, window.scrollY);
      }
      if (z.config.historyEnabled) history.replaceState({ htmx: true }, Z().title, window.location.href);
    }
    function Dt(e) {
    ...
    function Bt(a) {
      ...
      var o = { path: a, xhr: e };
      ie(Z().body, "htmx:historyCacheMiss", o);
      e.open("GET", a, true);
      e.setRequestHeader("HX-History-Restore-Request", "true");
      e.onload = function () {
        if (this.status >= 200 && this.status < 400) {
          ie(Z().body, "htmx:historyCacheMissLoad", o);
          var e = l(this.response);
          e = e.querySelector("[hx-history-elt],[data-hx-history-elt]") || e;
          var t = Nt();
          var r = S(t);
          var n = ke(this.response);
          if (n) {
            var i = b("title");
            if (i) {
              i.innerHTML = n;
          ...
          Ft(r.tasks);
          At = a;
          ie(Z().body, "htmx:historyRestore", { path: a, cacheMiss: true, serverResponse: this.response });
        } else {
          ne(Z().body, "htmx:historyCacheMissLoadError", o);
        }
      };
      e.send();
    }
    function jt(e) {
      ...
      if (t) {
        ...
        At = e;
        ie(Z().body, "htmx:historyRestore", { path: e, item: t });
      } else {
    ...
    function Jt(e, t) {
      ...
      var a = [];
      var o = Y(e);
      var s = (h(e, "form") && e.noValidate !== true) || J(e, "hx-validate") === "true";
      ...
      var u = fe(e, "hx-include");
      Q(u, function (e) {
        zt(r, n, a, e, s);
        if (!h(e, "form")) {
          Q(e.querySelectorAll(_e), function (e) {
            zt(r, n, a, e, s);
          });
        }
      });
    ...
    function rr(e) {
      return (
        $(e, "hx-encoding") === "multipart/form-data" || (h(e, "form") && G(e, "enctype") === "multipart/form-data")
      );
    }
    function nr(t, r, n) {
      var i = null;
    ...
    function sr(e, t) {
      return ar(e, "hx-vars", true, t);
    }
    function lr(e, t) {
      return ar(e, "hx-vals", false, t);
    }
    function ur(e) {
      return te(sr(e), lr(e));
    }
    ...
    function cr(t) {
      if (t.responseURL && typeof URL !== "undefined") {
        try {
          ...
          ne(Z().body, "htmx:badResponseUrl", { url: t.responseURL });
        }
      }
    }
    function E(e, t) {
    ...
    function ae(e, t, n, r, i, M) {
      ...
      var l = i.targetOverride || he(n);
      if (l == null || l == ue) {
        ne(n, "htmx:targetError", { target: J(n, "hx-target") });
        return;
      }
      if (!M) {
        var X = function () {
      ...
      if (z.config.getCacheBusterParam && e === "get") {
        q["org.htmx.cache-buster"] = G(l, "id") || "true";
      }
      if (t == null || t === "") {
        t = Z().location.href;
      }
      var T = ar(n, "hx-request");
      var H = Y(n).boosted;
      var L = {
        boosted: H,
        parameters: q,
          ...
          try {
            ...
            var o = function () {
              ...
              if (h.type) {
                if (h.type === "push") {
                  Dt(h.path);
                  ie(Z().body, "htmx:pushedIntoHistory", { path: h.path });
                } else {
                  Xt(h.path);
                  ie(Z().body, "htmx:replacedInHistory", { path: h.path });
                }
              }
              ...
              if (E(u, /HX-Trigger-After-Settle:/i)) {
                ...
                Me(u, "HX-Trigger-After-Settle", r);
              }
              K(v);
            };
            if (c.settleDelay > 0) {
    ...
    wr(function () {
      ...
      window.onpopstate = function (e) {
        if (e.state && e.state.htmx) {
          jt();
          Q(t, function (e) {
            ie(e, "htmx:restored", { document: Z(), triggerEvent: ie });
          });
        }
      };
      setTimeout(function () {
