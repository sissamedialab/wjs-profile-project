...
from .views import (
    ...
    DirectorWorkOnIssue,
    DownloadSingleFile,
    DownloadSingleFileImage,
    DraftArticlePageView,
    EditorArchived,
...
urlpatterns = [
    ...
    path("eo/issues/<int:pk>/edit/", IssueParametersUpdateView.as_view(), name="wjs_review_issueparameter_edit"),
    ...
    path("director/production/", DirectorProduction.as_view(), name="wjs_review_director_production"),
    ...
    path("select_reviewer/<int:pk>/", SelectReviewerView.as_view(), name="wjs_select_reviewer"),
    path(
    ...
    path(
        "janeway_article_page/<int:aw_id>/<str:file_name>/",
        DownloadSingleFileImage.as_view(),
    ...
    path("", include("plugins.wjs_review.synctex.urls")),
