...
THEME_CSS_FILES = [
    ...
    os.path.join(BASE_THEME_DIR, "css", "jquant.css"),
    os.path.join(BASE_THEME_DIR, "css", "jquant_nav.css"),
    os.path.join(BASE_THEME_DIR, "css", "jcap.css"),
    os.path.join(BASE_THEME_DIR, "css", "jcap_nav.css"),
